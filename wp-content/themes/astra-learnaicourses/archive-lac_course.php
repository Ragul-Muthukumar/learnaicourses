 ...
 *
 * Process: print a plain page header, then the main course query as a grid.
 */
...
<div id="primary" <?php astra_primary_class(); ?>>
	<header class="lac-page-head">
		<div class="lac-wrap">
			...
			<p class="lac-lede"><?php echo esc_html( $lac_archive_count ); ?> courses covering prompting, APIs, agents, and applied workflows. Filter by opening a course for level, hours, and price.</p>
		</div>
	</header>

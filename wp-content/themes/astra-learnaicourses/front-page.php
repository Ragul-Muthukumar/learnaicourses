<?php
/**
 * Front page: institute-style overview plus a live course sample.
 *
 * Process:
 * 1) Print a text hero (no full-bleed generated artwork).
 * 2) Link to existing learning-path pages.
 * 3) Query published courses for the catalog preview.
 */
		...
		<div class="lac-wrap">
			...
			<div class="lac-steps">
				<div class="lac-step">
					...
					<span>Sign in from the site header. Course pages require a logged-in learner to enroll.</span>
				</div>
				<div class="lac-step">

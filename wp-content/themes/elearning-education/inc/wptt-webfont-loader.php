...
if ( ! function_exists( 'elearning_education_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function elearning_education_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'elearning_education_wptt_get_web_font_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function elearning_education_wptt_get_web_font_url( $url, $format = 'woff2' ) {
		$font = new Elearning_Education_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
